...
def life_v7(grid, hours_of_simulation, time_growth_update, layers):
    ...
    M = np.load('/Users/Oliver_Leblanc/Desktop/RUNS/RUN2/1week4M.npy')
    diff_grid = np.load('/Users/Oliver_Leblanc/Desktop/RUNS/RUN2/1week4diff.npy')
    ox_grid = np.load('/Users/Oliver_Leblanc/Desktop/RUNS/RUN2/1week4ox.npy')
    red_grid = np.load('/Users/Oliver_Leblanc/Desktop/RUNS/RUN2/1week4red.npy')   
    ...
    np.savetxt(os.path.join("/Users/Oliver_Leblanc/Desktop/RUNS/RUN2", '1week5.txt'), plotting_data)
    np.save(os.path.join("/Users/Oliver_Leblanc/Desktop/RUNS/RUN2", '1week5M'), M)
    np.save(os.path.join("/Users/Oliver_Leblanc/Desktop/RUNS/RUN2", '1week5diff'), diff_grid)
    np.save(os.path.join("/Users/Oliver_Leblanc/Desktop/RUNS/RUN2", '1week5ox'), ox_grid)
    np.save(os.path.join("/Users/Oliver_Leblanc/Desktop/RUNS/RUN2", '1week5red'), red_grid)
